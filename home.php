...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="index.php">A-Tech</a>
...
<table width="1250">
	<tr>
		<td width="104" align="left" valign="top">IT'S RIGHT COLUMN!</td>
		<td width="983" align="left">
	<article>
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
		...
		<td width="147" align="left" valign="top"><?php include "calendar.php"; ?></td>
	</tr>
</table>
    <hr>
