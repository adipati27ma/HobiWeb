...
$has = mysqli_query( $link, "SELECT * FROM artikel ORDER BY id_artikel DESC LIMIT $per_laman OFFSET $awal");
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Header -->
		<header class="masthead" style="background-image: url('img/programmingcode.png')">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 mx-auto">
            <div class="site-heading">
              <h1>A-Tech</h1>
              <p class="subheading">Learning, Knowledge, Technology, Information, and Applications</p>
