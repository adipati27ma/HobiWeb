...
$has = mysqli_query( $link, "SELECT * FROM artikel WHERE isi_artikel LIKE '%$keyword%' OR judul_artikel LIKE '%$keyword%' ORDER BY judul_artikel ASC");
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
					...
					<?php
					echo 'Hasil pencarian untuk "'.$keyword.'"</button>';

					if($num<1){
				echo'	<center><br><br>Maaf konten yang anda cari tidak ada. . .<br>
						Jika anda ingin request mengenai konten tersebut, anda bisa mengirim saya email di Contact Me</center>';
				}else{
		  ...
		  <div class="clearfix">
		  	...
		  	<a class="btn btn-primary float-left" href="index?laman=<?php echo $laman_sekarang - 1 ?>">&larr; Previous</a>
		  <?php }else { ?>

			<a class="btn btn-primary float-left disabled">&larr; Previous</a>
  		  <?php } ?>
			<?php if($laman_sekarang < $total_laman) {?>

			<a class="btn btn-primary float-right" href="index?laman=<?php echo $laman_sekarang + 1 ?>">Next &rarr;</a>
		  <?php }else {?>
